                    ...
                    >
                      ...
                      {header && (
                        <div
                          ...
                          className={`absolute right-0 top-0 h-full w-[4px] cursor-col-resize hover:bg-black/20 touch-none select-none z-30 transition-colors ${
                            header.column.getIsResizing() ? "bg-black/30" : ""
                          }`}
                        />
                      )}
                    </th>
                                                ...
                                                (ts: any, idx: number) => {
                                                  ...
                                                  return (
                                                    <div key={idx} className="w-full relative">
                                                      ...
                                                      {isThisRowEditing && (
                                                        <div 
                                                          className="absolute z-[999999] bottom-0 right-0 bg-white p-3 rounded-lg shadow-[0_5px_20px_rgba(0,0,0,0.5)] border-[3px] flex flex-col gap-4 min-w-[240px]"
